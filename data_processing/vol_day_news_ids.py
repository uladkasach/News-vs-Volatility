...
## methods
def extract_full_ids(day, days_to_subtract, date_to_start, date_to_end):
    ...
    full_ids = relevant_news.index.tolist();
...
this_day = 0;
def applicator(date):
    result = extract_full_ids(date, days_to_subtract, date_to_start, date_to_end); ## get full_tokens
...
file_path = "../data/vol_day/indicies."+str(args.period) + "_days_before." + args.start_year + "_to_" + args.end_year+".for_" + file_name_no_ext;
