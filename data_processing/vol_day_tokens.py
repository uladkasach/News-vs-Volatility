'''
    convert lists of tokens for each volday into tokens
'''
import numpy as np
...
delta_mod = str(args.period) + "_days_before." + args.start_year + "_to_" + args.end_year;
file_path = "../data/vol_data/tokens.aggregated."+delta_mod+".hdf";
